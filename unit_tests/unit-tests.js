...
describe('Check if all my utilities functions are working as expected', () => {
  ...
  it('Check randomDates()', () => {
    ...
    const diffDays1 = Math.ceil((Math.abs(value1.entryDate - value1.leavingDate)) / (1000 * 60 * 60 * 24));
    ...
    const diffDays2 = Math.ceil((Math.abs(value2.entryDate - value2.leavingDate)) / (1000 * 60 * 60 * 24));
    ...
    const diffDays3 = Math.ceil((Math.abs(value3.entryDate - value3.leavingDate)) / (1000 * 60 * 60 * 24));
    ...
    const diffDays4 = Math.ceil((Math.abs(value4.entryDate - value4.leavingDate)) / (1000 * 60 * 60 * 24));
